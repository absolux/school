...
<div class="row" style="margin-bottom: 10px">
    ...
    <div class="col-md-4 text-right">
      <form action="<?php echo site_url('filieres/index'); ?>" class="form-inline" method="get">
        <div class="form-group">
            <input type="text" class="form-control" name="q" value="<?php echo $q; ?>" placeholder="Rechercher">
        </div>
        <span class="form-group-btn">
            <?php echo ($q <> '') ? anchor('filieres', '<i class="glyphicon glyphicon-remove"></i>', 'class="btn btn-default" title="Annuler le filtre"') : '' ?>
