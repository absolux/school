...
<?php echo form_open($action, 'class="form-horizontal"', ['id' => $id]) ?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6 <?php echo form_error("id_annee") ? 'has-error' : '' ?>">
      <?php echo form_dropdown("id_annee", ['' => "Sélectionnez"] + $annees, $id_annee, 'class="form-control" required') ?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6 <?php echo form_error("id_niveau") ? 'has-error' : '' ?>">
      <?php echo form_dropdown("id_niveau", ['' => "Sélectionnez"] + $niveaux, $id_niveau, 'class="form-control" required') ?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6 <?php echo form_error("id_filiere") ? 'has-error' : '' ?>">
      <?php echo form_dropdown("id_filiere", ['' => "Sélectionnez"] + $filieres, $id_filiere, 'class="form-control" required') ?>
