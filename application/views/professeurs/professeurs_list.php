...
<div class="row" style="margin-bottom: 10px">
    <div class="col-md-4">
        <?php echo anchor(site_url('professeurs/create'),'Créer un professeur', 'class="btn btn-warning"'); ?>
    </div>
    ...
    <div class="col-md-4 text-right">
      <form action="<?php echo site_url('professeurs/index'); ?>" class="form-inline" method="get">
        ...
        <span class="form-group-btn">
            <?php echo ($q <> '') ? anchor('professeurs', '<i class="glyphicon glyphicon-remove"></i>', 'class="btn btn-default" title="Annuler le filtre"') : '' ?>
